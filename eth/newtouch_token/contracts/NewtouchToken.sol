...
contract NewtouchToken is ERC20, Whitelist, Pausuale{
    ...
    function transfer(address to, uint256 value) public override verify(msg.sender, to, value) whenNotPaused returns (bool success){
